...
mod test {
    ...
    fn test_decode_block() {
        // This is base64 data for this block on the Persistence Core chain:
        // https://www.mintscan.io/persistence/block/14678207
        // This base64 data has been fetched from a Self hosted Firehose deployment.
        ...
        // deduping as it happens here before the triggers are passed to the subgraph
        // https://github.com/graphprotocol/graph-node/blob/8c6edc195102ee11a0767c77201a043aac45366b/graph/src/blockchain/block_stream.rs#L225
        triggers.sort();
        triggers.dedup();
